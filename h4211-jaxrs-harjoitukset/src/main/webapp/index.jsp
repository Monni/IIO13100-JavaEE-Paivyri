...
<html>
    <head>
    	...
    	function validate() {
    		...
    		if (left.value.length > 0 && !$.isNumeric(left.value)) {
    			alert("Syötä numeroarvo vasemmanpuoleiseen kenttään!");
    			valid = false;
    		}
    		
    		if (right.value.length > 0 && !$.isNumeric(right.value)) {
    			alert("Syötä numeroarvo oikeanpuoleiseen kenttään!");
    			valid = false;
    		}
    		
    		// Älä salli negatiivisia arvoja
    ...
    <body>
		...
		<a href="naytalaskut.jsp">Näytä kaikki laskut tietokannasta</a>     
    </body>
</html>
